                ...
                <section className="our-market-partners section">
                    <div className="container">
                            ...
                            <div className="col-md-12">
                                <div className="text">
                                    <h4 className="fadeInUp" data-wow-delay="0.2s">
                                        {
                                        currentPage.commercialinmarketpartners ? currentPage.commercialinmarketpartners.inMarketPartnersTitle : null
                                        }
                                    </h4>
                                    <p>{currentPage.commercialinmarketpartners ? currentPage.commercialinmarketpartners.inMarketPartnersTitleContent : null}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            {
                                currentPage.commercialinmarketpartners && currentPage.commercialinmarketpartners.subDistributionPartners ?
...
export const AboutPageQuery = graphql`
  ...
  allWpSolution (sort: {menuOrder: ASC} filter: {locale: {id: {eq: $langCode} } }) {
    ...
    allWpPartner(filter: {locale: {id: {eq: "en_US"}}, PartnersData: {showAsCommercialPartner: {eq: true}}}) {
        edges {
          node {
            id
            title
