...
const PageTemplate = (props) => {
    let allnews = props.data.allWpInthenews.edges;
                        ...
                        <div className="row justify-content-between">
                            <div className="col-lg-9 newslistingleft">
                                <div className="featuredwrapper">
                                    <h2>{SiteTrans.featured_lable[currentPage.locale.id]}</h2>
                                    <div className="row">
                                            ...
                                            return(<div className="col-sm-6">
                                                <div className="newsperbx">
                                                    ...
                                                    <div className="textbx">
                                                        {item.node.date && item.node.press_release_acf.location ?
                                                        ...
                                                        <div className="row bottomrow">
                                                            ...
                                                            <div className="col-7">
                                                                <ul className="socialbx">
                                                                    ...
                                                                    <li>
                                                                        <a href="#/" className="sicons shareclick"><img src={shareImage} alt="img" /></a>
                                ...
                                <div className="d-none d-md-block">
                                    {currentPage.locale.id === "en_US" ?
                                        <section id="text-2" className="widget widget_text">
                                            <div className="textwidget"><div className="rtbx for-inq">For press inquiries <a href="mailto:press@jameelhealth.com">click here</a>, or call +971 4 448 0906 (GMT +4 hours UAE). For public inquiries <a href="mailto:inquiries@jameelhealth.com"> click here.</a></div>
                                            </div>
                                        </section> :
                                        currentPage.locale.id === "ar" ?
                                        <section id="text-2" className="widget widget_text">
                                        ...
                                        <section id="text-2" className="widget widget_text">
                                            <div className="textwidget"><div className="rtbx for-inq">For press inquiries <a href="mailto:press@jameelhealth.com">click here</a>, or call +971 4 448 0906 (GMT +4 hours UAE). For public inquiries <a href="mailto:inquiries@jameelhealth.com"> click here.</a></div></div>
                                        </section>
                                    }
                                </div>
                            </div>
                                ...
                                <div>
                                                    ...
                                                    <div className="imgbx">
                                                        <Link to={item.node.localizedWpmlUrl} className="imgbx">
                                                            {item.node.featuredImage.node.sourceUrl ?
                                                                <img title="" src={item.node.featuredImage !== null ? item.node.featuredImage.node.sourceUrl : ''} alt={item.node.featuredImage ? item.node.featuredImage.node.altText : ''} />
                                                                : null}
                                                        </Link>
                                                    </div>
                                                    <div className="textbx">
                                                        ...
                                                        {item.node.press_release_acf.shortTitle?
                                                            <Link to={item.node.localizedWpmlUrl}><h4>{item.node.press_release_acf.shortTitle}</h4></Link>
                                                            :null
                                                        }
                                                        <p>{item.node.press_release_acf.summary}</p>
                                    ...
                                    {nonfeaturedNews.length > (pageNo * pageSize) ?
                                        <div className="loadmorewrap" id="showMoreContainer">
                                            <button className="ajaxloadmorebutton" onClick={() => { setPage() }}>{currentPage.locale.id === "en_US" ? "Show More" : currentPage.locale.id === "ar" ? "إظهار المزيد" : "Show More"}</button>
                                        </div>
                                        : null}
                                </div>
                            </div>
...
export const pageQuery = graphql `
    query intheNewsLis($id: String!, $langCode: ID!) {
