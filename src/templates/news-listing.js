...
const PageTemplate = (props) => {
    let allnews = props.data.allWpPressrelease.edges;
                        ...
                        <div className="row justify-content-between">
                            <div className="col-lg-9 newslistingleft">
                                <div className="featuredwrapper">
                                    <h2>
                                        {SiteTrans.featured_lable[currentPage.locale.id]}
                                    </h2>
                                                ...
                                                <div className="newsperbx">
                                                    ...
                                                    <div className="textbx">
                                                        <div className="timings">
                                                            <p>
                                                                <img className="servicon" src="https://media.aljhealth.com/wp-content/uploads/2021/02/10131409/calender.png" alt="img" />
                                                        ...
                                                        <div className="row bottomrow">
                                                            <div className="col-5">
                                                                <Link className="readmore" to={item.node.localizedWpmlUrl}>{SiteTrans.read_more_txt[currentPage.locale.id]}</Link>
                                                            </div>
                                                            <div className="col-7">
                                    ...
                                    {currentPage.locale.id === "en_US" ?
                                        <section id="text-2" className="widget widget_text">
                                            <div className="textwidget">
                                                <div className="rtbx for-inq">For press inquiries <a href="mailto:press@jameelhealth.com">click here</a>, or call +971 4 448 0906 (GMT +4 hours UAE). For public inquiries <a href="mailto:inquiries@jameelhealth.com"> click here.</a>
                                                </div>
                                            </div>
                                        </section> : currentPage.locale.id === "ar" ?
                                        <section id="text-2" className="widget widget_text">
                                            <div className="textwidget">
                                    ...
                                    <div className="row">
                                        {nonfeaturedNews.filter((itm, index) => index < (pageNo * pageSize)).map((item, i) =>{
                                            var date = item.node.date;
                                                        ...
                                                        var newsandinsightsdate = translateDate(month,currentPage.locale.id)+' '+arr2[0]+', '+arr3;
                                        return (
                                            <div className='col-sm-6 newsBox'>
                                                <div className="newsperbx">
                                                    <div className="imgbx">
                                                        <Link to={item.node.localizedWpmlUrl} className="imgbx">
...
export const pageQuery = graphql `
    query currentPageQueryAndCurrentPageQuery($id: String!, $langCode: ID!) {
