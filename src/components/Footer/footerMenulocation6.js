...
const FooterMenuLocation6 = (props) => {

const menuqry = useStaticQuery(graphql`
{
    menuEn:  wpMenu(name: {eq: "Footer Menu 6 EN"}) {
        menuItems {
          nodes {
            label
            parentId
    ...
    menuAr: wpMenu(name: {eq: "Footer Menu 6 AR"}) {
      menuItems {
        nodes {
          label
          parentId
      ...
      menuTr:  wpMenu(name: {eq: "Footer Menu 6 TR"}) {
        menuItems {
          nodes {
            label
            parentId
...
export default FooterMenuLocation6
