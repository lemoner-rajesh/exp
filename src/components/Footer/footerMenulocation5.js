...
const FooterMenuLocation5 = (props) => {

const menuqry = useStaticQuery(graphql`
{
    menuEn:  wpMenu(name: {eq: "Footer Menu 5 EN"}) {
        menuItems {
          nodes {
            label
            parentId
    ...
    menuAr: wpMenu(name: {eq: "Footer Menu 5 AR"}) {
      menuItems {
        nodes {
          label
          parentId
      ...
      menuTr:  wpMenu(name: {eq: "Footer Menu 5 TR"}) {
        menuItems {
          nodes {
            label
            parentId
...
export default FooterMenuLocation5