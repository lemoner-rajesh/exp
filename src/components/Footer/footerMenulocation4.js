...
const FooterMenuLocation4 = (props) => {

const menuqry = useStaticQuery(graphql`
{
    menuEn:  wpMenu(name: {eq: "Footer Menu 4 EN"}) {
        menuItems {
          nodes {
            label
            parentId
    ...
    menuAr: wpMenu(name: {eq: "Footer Menu 4 AR"}) {
      menuItems {
        nodes {
          label
          parentId
      ...
      menuTr:  wpMenu(name: {eq: "Footer Menu 4 TR"}) {
        menuItems {
          nodes {
            label
            parentId
...
export default FooterMenuLocation4
